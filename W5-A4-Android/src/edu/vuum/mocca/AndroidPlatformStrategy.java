...
{	
    ...
    public void print(final String outputString)
    {
         ...
         */
        // TODO - You fill in here.
    	//System.out.println(outputString + System.getProperty("line.separator"));
    	//mTextViewOutput.append(outputString +  "\n");
    	 //String text = mTextViewOutput.getText().toString();
         //final String textToDisplay = text.isEmpty() ? outputString : outputString + System.getProperty("line.separator");
    	...
    	//activity.runOnUiThread(new Runnable() {
             ...
             public void run() {
            	 ...
            	 // It is get from https://class.coursera.org/posa-002/lecture/67
            	 mTextViewOutput.append(outputString+"\n");
